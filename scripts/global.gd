...
const STAFF_SPACE_HEIGHT = 11
const MIN_NOTATION_X_GAP = STAFF_SPACE_HEIGHT*0.7
const BEAM_YSIZE = STAFF_SPACE_HEIGHT*0.45
...
const TIE_HEIGHT = STAFF_SPACE_HEIGHT*0.7
const TIE_XGAP = STAFF_SPACE_HEIGHT*0.75
const TIE_YGAP = STAFF_SPACE_HEIGHT/7.0
const TIE_XPERCENTAGE = 0.3
const TIE_YPERCENTAGE = 1.2
const TEMPO_YSIZE = STAFF_SPACE_HEIGHT*2.5
