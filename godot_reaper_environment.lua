function runGodotReaperEnvironment(isReaper, funcStr, drumkitFileText, gemNameTable, configTextTable, outputTextFilePath, imgSizesFileText, temposFileText, eventsFileText, midiFileText, drumTake, drumTrack, drumTrackID, eventsTake, eventsTrack, eventsTrackID)
